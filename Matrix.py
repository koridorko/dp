...
class MatrixPayloadCreator():
    ...
    @staticmethod
    def create_candidate_payload(call_id: str, 
                                 version: int, 
                                 sdp_mid: str, 
                                 sdp_mline_index: int) -> dict:
        ...
        payload = {
            ...
            "candidate":
                {
                    "candidate": f"candidate:1 1 UDP 2130706431"
                },
            "sdpMid": sdp_mid,
            "sdpMLineIndex": sdp_mline_index,
            "event_type": MatrixEventType.CANDIDATE.value,
            "txn_id": str(random.randint()) # This should be unique for each transaction
        }
